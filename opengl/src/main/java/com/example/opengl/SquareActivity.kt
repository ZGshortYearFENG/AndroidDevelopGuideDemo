...
class SquareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(SquareSurfaceView(this))
    }
}

/**
 * 跟TriangleSurfaceView的区别：
 * 修改顶点数据数据 mVertex mColor，buffer的内存增大
 * 最后GLES20.glDrawArrays的模式改成 GL_TRIANGLE_STRIP，并且顶点数量改成4
 */

class SquareSurfaceView(context: Context, attributeSet: AttributeSet? = null) :
